...
class YourTeachableMachine {
  ...
  async loadModel({ modelUrl }) {
    if (!modelUrl || modelUrl === "") {
      console.error("[YourTeachableMachine] -", "Missing model URL!");
    ...
    try {
      ...
      console.error("[YourTeachableMachine] -", e);
    }
  }
  ...
  async inference({ imagePath, fileType }) {
    try {
...
module.exports = YourTeachableMachine;
